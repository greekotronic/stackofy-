  ...
  if (size === 'featured') {
    return `
      <a href="${article.url}" class="featured-xl mb3">
        <div class="featured-xl-img" style="${bg}; background-image:url('${article.image}'); background-size:cover; background-position:center 30%; background-repeat:no-repeat;"></div>
